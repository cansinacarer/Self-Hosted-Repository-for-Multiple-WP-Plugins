...
$screenshots = Markdown($config['screenshots']);
$faq = Markdown($config['faq']);
...
if ($action == 'plugin_information') {	
    ...
    $data->download_link = $package['package'];
    $data->requires = $package['requires'];
    $data->tested = $package['tested'];
    // $data->rating = 96;
    // $data->num_ratings = 154;
    // $data->downloaded = 1256;
